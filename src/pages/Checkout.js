...
import { DeleteItemAsync,
  UpdateItemAsync,
  selectItems} from '../features/cart/CartSlice';
  ...
  const handleDelete=(e,itemId)=>{
    ...
    return ( 
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
            <div className='mt-12 lg:col-span-3 bg-white'>
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            choose from Existing Addresses
                  ...
                  />
                            ...
                            <p className="text-sm font-semibold leading-6 text-gray-900">{address.city}</p>
                        ...
                        <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                            ...
                            <p className="text-sm font-semibold leading-6 text-gray-900">{address.pinCode}</p>
